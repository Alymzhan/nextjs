    ...
    return (
      <Fragment>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-CEWE9MYCHQ"></script>
          ...
          <meta charSet='UTF-8' />
          <meta name='description' content='Explore city using search or tags.' />
          <meta name='keywords' content='browse,explore,map-cy,roadmap,travelinfo' />
        </Head>
        <div>
          <Container fluid>
            <Row noGutters>
